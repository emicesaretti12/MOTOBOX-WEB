    ...
    filtered.forEach((moto, idx) => {
      ...
      card.innerHTML = `
        <div class="moto-card-header">
          ...
          <span class="moto-stock-indicator">
            <span class="live-dot" style="width: 5px; height: 5px;"></span> Stock 2026
          </span>
        ...
        <div class="moto-card-body">
          ...
          <div class="moto-pricing-block">
            <div>
              <span style="display: block; font-size: 0.7rem; color: var(--text-muted); font-family: var(--font-mono); text-transform: uppercase;">Precio de Lista</span>
              <div class="price-main-val ${isConsultPrice ? 'consult' : ''}">${formattedPrice}</div>
            </div>
            ${cuotaHtml}
          </div>
